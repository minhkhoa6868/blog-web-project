...
export default function BlogContent({ onSelect, image, accountImage, name, time }) {
    return (
        <div 
        ...
        >
            <BlogContentHeader onSelect={onSelect} accountImage={accountImage} name={name} time={time} />
